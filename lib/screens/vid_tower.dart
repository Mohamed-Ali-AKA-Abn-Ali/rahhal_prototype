...
class VidTower extends StatefulWidget {
  VidTower({super.key});

  @override
  State<VidTower> createState() => _VidTowerState();
}

class _VidTowerState extends State<VidTower> {
  VideoPlayerController _controller=VideoPlayerController.asset('assets/videos/cairoTowerVid.mp4');
