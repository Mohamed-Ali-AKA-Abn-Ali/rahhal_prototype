...
class VidPyramids extends StatefulWidget {
  VidPyramids({super.key});

  @override
  State<VidPyramids> createState() => _VidPyramidsState();
}

class _VidPyramidsState extends State<VidPyramids> {
  VideoPlayerController _controller=VideoPlayerController.asset('assets/videos/pyramidsVideo.mp4');
